...
| 5 | [Fusion + gravity camera](guides/05-fusion-gravity-camera.md) | 6-axis complementary filter, yaw drift | Madgwick ICORR 2011 |
| 6 | [Touch CST816](guides/06-touch-cst816.md) | One finger, double-tap recenter | CST816T registers + S English map |
...
A gravity-locked cube on this board. Core 0 runs QMI8658 at 100 Hz into a quaternion. Core 1, at 30 Hz, builds a **continuous** IMU boom camera, picks one of 20 dodecahedron **sheets** for the pet, rasters 6 room quads, blits indexed-8 sprites, and DMA-s a dirty rect into ST7789 GRAM. Impacts enqueue `SfxEvt`; Core 0 mixes two procedural voices into ES8311 and raises the NS4150B only while a voice is live. Wi-Fi is a guest.
